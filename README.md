...
We need build and maintain a model for the Product and build a process that will import product data from JSON files.  
This will be how we simulate creating or updating products as one would from an admin, but instead of its from a data file import.
...
- Documentation API REST - Upload file

`> https//:localhost/docs`

- Endpoint upload file

`> POST https//:localhost/import_products`

## Consume Messenger - Import

`> docker-compose exec php bin/console messenger:consume async_priority_high`

## Consume Messenger - Export

`> docker-compose exec php bin/console messenger:consume async_priority_low`
